...
<html>
	...
	<body>
		...
		<form name="frmStudent" method="post"  action="newStudentOk.jsp">
		 <table>
		 <!-- input tag의 name 속성의 값과 서버에서 사용할 StudentBean 클래스의 속성명을 일치 -->
	       ...
	       <tr><td>관심분야</td>
	                  <td><input type="checkbox"  id="web" value="웹" name="stdInterest">웹 프로그래밍
	                    <input type="checkbox"  id="design"  value="웹디자인" name="stdInterest">파이썬
	                    <input type="checkbox"  id="bigdata"  value="빅데이터" name="stdInterest">빅데이터
	                    <input type="checkbox"  id="java" value="자바" name="stdInterest">자바 프로그래밍</td></tr>
