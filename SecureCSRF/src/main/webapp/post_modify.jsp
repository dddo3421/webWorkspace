...
<body>
    ...
    <%
	  ...
	  String S_name = (String)session.getAttribute("S_name");
  	  String CSRF_TOKEN = (String)session.getAttribute("CSRF_TOKEN"); //로그인시 추가된 CSRF_TOKEN 추출, 서버에서 폼데이터 전달
    ...
    try
    {
        ...
        {%>
            ...
            <input type="hidden" name="num" value="<%=result.getInt("num") %>"><!--hidden속성이용 글번호를 서버에 전송 -->
            <table border="1">
                <tr>
                    <td>작성자</td>
