...
<body>
	<form action="post_read.jsp" method="get">
		...
		<%
			...
			String S_Name = (String)session.getAttribute("S_name"); // 게시글 목록은 모든 사용자의 게시글을 볼 수 있기때문에 S_name session 속성은 사용안함
			...
			catch (Exception ex)
			{
				...
				response.sendRedirect("main.html"); //session정보를 페이지 요청시 갖고 오지 않았으면 메인페이지로 이동 
