...
<head>
    ...
    <script type="text/javascript">
		...
		// JavaScript에서 URL의 hash(# 뒤 문자열)을 가져오는 코드
		// #기호뒤에 문자열이 있으면 해당 문자열 반환, slice(idx) idx부터 끝까지 추출 
		// hash.slice(1) ->hash 문자열이 #first.jsp면 first.jsp
		if(hash){ //first.jsp -> 일반 문자열(url 형식으로 구성해야 href에 대입될 수 잇음)
